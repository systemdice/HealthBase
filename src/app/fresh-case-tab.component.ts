...
@Component({
  selector: 'app-fresh-case-tab',
  templateUrl: './fresh-case-tab.component.html',
  styleUrls: ['./fresh-case-tab.component.css']
})
export class FreshCaseTabComponent implements OnInit {
  ...
  constructor(private _fb: FormBuilder, public dialog: MatDialog, private route: ActivatedRoute,
    ...
    public appointmentDetailService: AppointmentDetailService, private _store: StorageService,public  vaccineCategoriesService:  VaccinationsCategoryService,
