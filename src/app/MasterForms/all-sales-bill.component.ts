...
@Component({
  selector: 'app-all-sales-bill',
  templateUrl: './all-sales-bill.component.html',
  styleUrls: ['./all-sales-bill.component.css']
})
export class AllSalesBillComponent implements OnInit {
  displayedColumns: string[] = ['slno', 'BillNo', 'PharmacyStoreName','BillingDate', 'IPDOPDId', 'CustomerName', 'CeditStatus', 'CaseID', 'action'];
