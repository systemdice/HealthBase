...
@Component({
  selector: 'app-account-book-category',
  templateUrl: './account-book-category.component.html',
  styleUrls: ['./account-book-category.component.css']
})
export class AccountBookCategoryComponent  implements OnInit {
  displayedColumns: string[] = ['slno', 'UnqueID', 'DateStart', 'IPDOPDId','CaseStatus','PaymentHistory'];
