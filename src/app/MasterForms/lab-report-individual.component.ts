...
import { LabTestMaster, NewModifyCase } from '../models/UserData';
...
@Component({
  selector: 'app-lab-report-individual',
  templateUrl: './lab-report-individual.component.html',
  styleUrls: ['./lab-report-individual.component.css']
})
export class LabReportIndividualComponent implements OnInit {
  jwt: string;
