...
@Component({
  selector: 'app-nebulizer-details',
  templateUrl: './nebulizer-details.component.html',
  styleUrls: ['./nebulizer-details.component.css']
})
export class NebulizerDetailsComponent implements OnInit {
  @Input() CaseDetails;
  @Input() Nebulization : FormGroup;
  @Input() caseid:string; 
  myDate = new Date();
  ...
  oninputChange(per: string) {
   ...
   /** Teachers */
   teachers(): FormArray {
    return this.Nebulization.get("teachersNebulization") as FormArray
  }
