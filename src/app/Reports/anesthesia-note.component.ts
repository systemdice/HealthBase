...
@Component({
  selector: 'app-anesthesia-note',
  templateUrl: './anesthesia-note.component.html',
  styleUrls: ['./anesthesia-note.component.css']
})
export class AnesthesiaNoteComponent implements OnInit {
