...
@Component({
  selector: 'app-continuation-report',
  templateUrl: './continuation-report.component.html',
  styleUrls: ['./continuation-report.component.css']
})
export class ContinuationReportComponent implements OnInit{ 
