...
@Component({
  selector: 'app-patient-registration-first-page',
  templateUrl: './patient-registration-first-page.component.html',
  styleUrls: ['./patient-registration-first-page.component.css']
})
export class PatientRegistrationFirstPageComponent implements OnInit {
